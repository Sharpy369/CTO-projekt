            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              <div className="flex-1 text-center lg:text-left">
                <Badge variant="secondary" className="mb-4 py-1 px-3 bg-blue-50 text-blue-700 border-blue-100">
                  Air Conditioning Specialists — Custom Solution
                </Badge>
                <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6 leading-[1.1]">
                  24/7 Emergency Intake.<br />
                  <span className="text-blue-600 underline decoration-blue-200 underline-offset-4">Instant</span> Dispatch.
                </h1>
                <p className="text-lg text-slate-600 mb-8 max-w-2xl mx-auto lg:mx-0">
                  We are testing your custom AI assistant. It handles emergency after-hours intake, 
                  job scheduling, and FAQ — syncing directly with ServiceTitan.
                </p>
            ...
            <Card className="bg-slate-900 text-white p-8">
              ...
              <div className="space-y-4 text-sm text-slate-400">
                <div className="flex justify-between border-b border-slate-800 pb-2">
                  ...
                  <span className="text-blue-400 font-mono">6a043d8944cd7fb75870b224</span>
                </div>
                <div className="flex justify-between border-b border-slate-800 pb-2">
                  <span>ServiceTitan Sync</span>
